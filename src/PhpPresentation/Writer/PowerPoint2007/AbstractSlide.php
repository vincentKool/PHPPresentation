...
abstract class AbstractSlide extends AbstractDecoratorWriter
{
     ...
     * @throws \Exception
     */
    protected function drawingRelations(AbstractSlideAlias $pSlideMaster, $objWriter, $relId)
    {
     ...
     * @param $objWriter
     */
    protected function writeSlideBG(SlideMaster $pSlide, XMLWriter $objWriter)
    {
